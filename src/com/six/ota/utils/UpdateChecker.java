...
import com.six.ota.UpdaterApplication;
import com.six.ota.activities.UpdaterActivity;
import com.six.ota.misc.Constants;
import com.six.ota.misc.State;
import com.six.ota.misc.UpdateInfo;
import com.six.ota.requests.UpdatesJsonObjectRequest;
import com.six.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.six.ota.action.UPDATE_CHECK_FINISHED";
